...
class _CreatePageState extends State<CreatePage> {
  ...
  Future _getImage() async {
    ...
    final XFile? image = await _picker.pickImage(source: ImageSource.gallery, maxWidth: 640, maxHeight: 480);
  ...
  Future _uploadFile(BuildContext context) async {
    ...
    task.whenComplete(() {
      // 업로드 완료 후 url 획득
      var downloadUrl = firebaseStorageRef.getDownloadURL();
